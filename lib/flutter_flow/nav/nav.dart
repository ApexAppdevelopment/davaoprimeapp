...
class AppStateNotifier extends ChangeNotifier {
  DavaoprimecreationFirebaseUser? initialUser;
  DavaoprimecreationFirebaseUser? user;
  ...
  void update(DavaoprimecreationFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'phonesignup',
              path: 'phonesignup',
              builder: (context, params) => PhonesignupWidget(),
            ),
            FFRoute(
              name: 'VerifyCodeSMS',
              path: 'verifyCodeSMS',
              builder: (context, params) => VerifyCodeSMSWidget(),
            ),
            FFRoute(
              name: 'homepage',
              path: 'homepage',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Macro_Plex_4K_Motion_Background_Loop.gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
